        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-[#070a12]/95 backdrop-blur-xl rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border border-white/10">
            ...
            <div className="relative h-96 bg-black">
              ...
              <button
                onClick={prevImage}
                className="absolute left-4 top-1/2 -translate-y-1/2 glass-card p-3 rounded-full hover-scale"
              >
              ...
              <button
                onClick={nextImage}
                className="absolute right-4 top-1/2 -translate-y-1/2 glass-card p-3 rounded-full hover-scale"
              >
            ...
            <div className="p-8">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-3xl font-light text-deep-gray tracking-wide">
                  {selectedRoom.title}
                </h3>
                <div className="text-right">
                  <span className="text-3xl font-extralight text-burnt-orange">{selectedRoom.price}</span>
                  <span className="text-warm-gray font-light"> ₽/сутки</span>
                </div>
              </div>

              <p className="text-warm-gray/90 font-light leading-relaxed mb-6">
                {selectedRoom.description}
              </p>

              <h4 className="text-xl font-light text-deep-gray mb-4 tracking-wide">
                Удобства
              </h4>
              ...
              <Button 
                className="w-full glass-button font-light text-lg py-6"
                onClick={() => {
